...
namespace EM.GIS.Data
{
    ...
    public static class Global
    {
        ...
        {
            byte retNum;
            if (byte.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum))
            {
                return retNum;
            }
        ...
        {
            double retNum;
            return double.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum) ? retNum : double.NaN;
        }
        ...
        {
            float retNum;
            return float.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum) ? retNum : 0F;
        }
        ...
        {
            int retNum;
            return int.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum) ? retNum : 0;
        }
        ...
        {
            short retNum;
            if (short.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum))
            {
                return retNum;
            }
        ...
        {
            return System.Convert.ToString(expression, CultureInfo.CurrentCulture.NumberFormat);
        }
        ...
        {
            byte retNum;
            bool isNum = byte.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum);
            return isNum;
        }
        ...
        public static bool IsDouble(object expression)
        {
            ...
            bool isNum = double.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum);
            return isNum;
        }
        ...
        {
            float retNum;
            bool isNum = float.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum);
            return isNum;
        }
        ...
        {
            int retNum;
            bool isNum = int.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum);
            return isNum;
        }
        ...
        {
            short retNum;
            bool isNum = short.TryParse(GetString(expression), NumberStyles.Any, CultureInfo.CurrentCulture.NumberFormat, out retNum);
            return isNum;
        }
